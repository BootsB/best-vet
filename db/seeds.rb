...
Post.create!(
  ...
  category_id: health_concerns.id,
  user: user
)
Post.create!(
...
Post.create!(
  ...
  category_id: behavior_and_training.id,
  user: user
)
Post.create!(
...
Post.create!(
  ...
  category_id: nutrition_and_diet.id,
  user: user
)
Post.create!(
...
Post.create!(
  ...
  category_id: senior_pet_care.id,
  user: user
)
Post.create!(
